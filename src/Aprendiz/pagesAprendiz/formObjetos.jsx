...
const FormObjetos = () => {
  return (
    ...
    <div className="relative sm:max-w-xl w-[50%] z-20">
        <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-sky-500 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
        </div>
